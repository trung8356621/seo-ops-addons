...
final class TopicalMapBoundaryContractTest extends TestCase
{
    ...
    public function test_ui_defaults_to_tree_and_exposes_three_renderers(): void
    {
        ...
        $theme = (string) file_get_contents(dirname(__DIR__, 3).'/resources/js/topical-map/charts/theme.js');
        self::assertStringContainsString('fontSize: 18', $theme);
        self::assertStringContainsString('getChartTypographyBand', $theme);
        self::assertStringContainsString('getStructureTypography', $theme);
        self::assertStringContainsString('getNetworkTypography', $theme);
