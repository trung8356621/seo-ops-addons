...
final class KeywordIntelligenceUiRedesignTest extends LaravelTestCase
{
    ...
    public function test_navigation_defaults_to_clusters_tab_first(): void
    {
        ...
        self::assertStringContainsString('getKeywordWorkspaceTabCounts', $nav);
        self::assertStringContainsString('KeywordUiInventoryQuery', $nav);
    ...
    public function test_cluster_index_view_uses_compact_layout_markers(): void
    {
        ...
        self::assertStringContainsString('keyword-module-chrome', file_get_contents(LegacyAddonPath::resolve(
            'resources/views/filament/resources/keywords/pages/partials/keyword-workspace-nav.blade.php',
        )));
        self::assertStringContainsString('topic-index-section-heading', $index);
        self::assertStringContainsString('topic_section_subtitle', $index);
        self::assertStringContainsString('topic-index-compact-stats', $index);
        ...
        self::assertStringNotContainsString('topic-index-stats', $index);
        self::assertStringNotContainsString('topic_page_heading', $index);
