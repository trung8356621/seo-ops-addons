...
final class CreateTopicHandler extends AbstractKeywordIntelligenceHandler
{
    ...
    public function handle(ContentProjectCommand $command, ActorContext $actor): ContentProjectActionResult
    {
        if (! $command instanceof CreateTopicCommand) {
            throw new InvalidArgumentException('Expected CreateTopicCommand.');
        }
        ...
        return $this->wrap(function () use ($command, $actor): ContentProjectActionResult {
            ...
            $topic = $this->mutations->createTopic($workspace, $command->attributes, $command->parentTopicRef);

            return ContentProjectActionResult::ok(
                KeywordIntelligenceActionCodes::TOPIC_CREATED,
                'Topic created.',
                metadata: [
                    'workspace_ref' => $workspace->public_ref,
                    'topic_ref' => $topic->public_ref,
                    'name' => $topic->name,
                    'parent_topic_ref' => $command->parentTopicRef,
                ],
            );
        });
    }
