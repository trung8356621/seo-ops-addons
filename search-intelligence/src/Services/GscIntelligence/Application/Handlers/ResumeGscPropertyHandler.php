...
use Omnichannel\Addons\SearchIntelligence\Services\GscIntelligence\Application\Commands\ResumeGscPropertyCommand;
...
final class ResumeGscPropertyHandler extends AbstractGscIntelligenceHandler
{
    ...
    {
        if (! $command instanceof ResumeGscPropertyCommand) {
            throw new InvalidArgumentException('Expected ResumeGscPropertyCommand.');
        }
        ...
        return $this->wrap(function () use ($command, $actor): ContentProjectActionResult {
            ...
            $property->status = GscPropertyStatus::Active;
            $property->sync_enabled = true;
            $property->save();

            return ContentProjectActionResult::ok(
                GscIntelligenceActionCodes::PROPERTY_RESUMED,
                'GSC property resumed.',
