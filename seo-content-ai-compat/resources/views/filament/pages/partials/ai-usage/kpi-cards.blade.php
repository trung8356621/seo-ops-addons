@php
    ...
    $cards = [
        ...
        [
            ...
            'hint' => number_format($seoShare, 1).__('% total tokens'),
            'tone' => 'green',
        ...
        [
            ...
            'hint' => number_format($seedingShare, 1).__('% total tokens'),
            'tone' => 'violet',
            'icon' => 'M7 7h10M7 12h10M7 17h6',
        ],
        [
            'label' => __('Total calls'),
            'value' => number_format((int) $tokenSummary['total_calls']),
            'meta' => 'AI requests',
            'hint' => __('Estimated cost is not displayed'),
            'tone' => 'orange',
