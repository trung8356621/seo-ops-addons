    ...
    'article_content_generate' => [
        ...
        'presentation' => [
            'default_instructions' => [
                ...
                'When an internal-link anchor is useful but you do not have a verified WordPress permalink, emit Markdown [anchor text](#) — never invent domain+slug or guess URLs.',
                'When you do have a verified authoritative permalink, emit [anchor text](REAL_URL). Prefer Markdown links over raw HTML <a>.',
    ...
    'keyword_discovery_structured' => [
        ...
        'presentation' => [
            ...
            'output_format' => [
                ...
                'source_signal: keyword_gap|cluster_gap|mcp_signal|gsc_signal|related_topic|manual_note (manual_focus accepted).',
                'Caller also accepts list entries as strings or objects with a keyword field.',
            ],
            'notes' => [
                'This Hook does not write keywords to the domain database — callers persist Draft planning items only.',
