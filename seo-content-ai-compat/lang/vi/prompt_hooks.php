...
PROMPT,
    ...
    'keyword_discovery_structured' => [
        ...
        'description' => 'Tạo gợi ý chủ đề và bài viết mới cho Lập kế hoạch nội dung.',
        'presentation' => [
            'default_instructions' => [
                'Tạo ý tưởng nội dung thành mục Draft planning — không viết bài hoàn chỉnh.',
                'Dùng Planning Intelligence; ghi chú (notes) là tùy chọn.',
                'Ưu tiên hướng chưa phủ; tránh trùng bài đã mạnh.',
                'Luôn có description (brief 1–3 câu) để làm rõ keyword SEO ngắn/mơ hồ.',
                'suggestion_reason ngắn, hướng người dùng — không chain-of-thought.',
                'Tôn trọng content_type (post|product) và ngôn ngữ chính hiệu lực.',
                'Chỉ trả JSON — không dùng markdown fence.',
            ],
            'output_format' => [
                'JSON array/object các gợi ý lập kế hoạch có cấu trúc.',
                'Hình dạng ưu tiên: {"keyword":"...","suggested_title":"...","description":"...","suggestion_reason":"...","source_signal":"keyword_gap"}.',
                'source_signal: keyword_gap|cluster_gap|mcp_signal|gsc_signal|related_topic|manual_note (chấp nhận manual_focus).',
                'Caller cũng chấp nhận chuỗi hoặc object có field keyword.',
            ],
            'notes' => [
                'Hook không ghi từ khóa vào database domain — chỉ persist mục Draft planning.',
                'New Content Planner không upsert Keyword Intelligence và không tạo Article.',
            ],
        ],
    ],
];
