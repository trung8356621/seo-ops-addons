...
final class DismissSeoAuditSuggestionsHandler extends AbstractPublishingHandler
{
    ...
    {
        if (! $command instanceof DismissSeoAuditSuggestionsCommand) {
            throw new InvalidArgumentException('Expected DismissSeoAuditSuggestionsCommand.');
        }
        ...
        return $this->wrap(null, function () use ($command, $actor): ContentProjectActionResult {
            ...
            $result = $this->decisions->dismissArticles($project, $command->articleIds, $actor->actorId);

            return ContentProjectActionResult::ok(
                ContentProjectActionCodes::SUGGESTIONS_DISMISSED,
                (int) $result['dismissed'].' suggestion(s) dismissed.',
                $projectId,
                metadata: $result,
            );
        });
