...
/**
 * Phase 2 SSE placeholder — no endpoint, no EventSource, no fan-out.
 */
final class NoOpContentProjectRunEventPublisher implements ContentProjectRunEventPublisher
{
