    ...
    public static function definitions(): array
    {
        return [
            ...
            'content_type' => [
                ...
                'cleanup' => false,
                'canonical_replacement' => null,
                'writers' => ['ArticleContentClassification', 'SyncDomainContentService'],
                'readers' => ['ArticleContentClassification', 'ArticlePostTypeResolver', 'ArticleResource'],
            ],
            'wp_is_term' => [
                'purpose' => 'WordPress object is taxonomy term (1) vs post/CPT (0)',
                'class' => self::CLASS_CANONICAL,
                'cleanup' => false,
                'canonical_replacement' => null,
                'writers' => ['ArticleContentClassification', 'SyncDomainContentService'],
                'readers' => ['ArticleContentClassification', 'WordPressArticleContentService', 'ArticleResource'],
            ],
            'wp_post_type' => [
                'purpose' => 'Raw platform native slug (WP post_type or taxonomy). Integration/debug only — never Article business branching',
                'class' => self::CLASS_CANONICAL,
                'cleanup' => false,
                'canonical_replacement' => null,
                'writers' => ['SyncDomainContentService', 'ArticleContentClassification'],
                'readers' => ['WordPress integration', 'DomainOverviewService', 'debug UI'],
            ],
            'wp_entity' => [
                'purpose' => 'DEPRECATED: post vs term — replaced by wp_is_term',
                'class' => self::CLASS_LEGACY,
                'cleanup' => true,
                'canonical_replacement' => 'wp_is_term',
                'writers' => [],
                'readers' => ['ArticleContentClassification (legacy infer only)'],
            ],
            'wp_taxonomy' => [
                'purpose' => 'Taxonomy slug when term; prefer wp_post_type for native identity',
                'class' => self::CLASS_COMPATIBILITY,
                'cleanup' => false,
                'canonical_replacement' => 'wp_post_type',
                'writers' => ['WordPressArticleSyncService', 'ArticleEditorBundleApplyService'],
                'readers' => ['WordPressArticleContentService'],
            ],
            'wp_slug' => [
