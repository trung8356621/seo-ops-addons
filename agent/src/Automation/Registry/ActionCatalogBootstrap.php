...
final class ActionCatalogBootstrap
{
    ...
    public function definitions(): array
    {
        return [
            ...
            new ActionDefinition(
                key: 'article.index_health.list_due',
                name: 'List Index Health due URLs',
                description: 'Count/list published URLs due for monthly index review. Does not query Google.',
                module: 'article',
                sideEffect: ActionSideEffect::Read,
                riskLevel: ActionRiskLevel::Low,
                selectability: ActionSelectability::Selectable,
            ...
            new ActionDefinition(
                key: 'article.index_health.record',
                name: 'Record Index Health check',
                description: 'Record an explicit manual index result (indexed|not_indexed|unknown). Requires caller-provided status — never invents Google results.',
                module: 'article',
                sideEffect: ActionSideEffect::InternalWrite,
                riskLevel: ActionRiskLevel::Medium,
                selectability: ActionSelectability::Selectable,
                inputSchema: [
                    'article_id' => ['type' => 'integer', 'required' => true],
                    'status' => ['type' => 'string', 'required' => true, 'enum' => ['indexed', 'not_indexed', 'unknown']],
                ...
                lockScope: 'article',
                supportsDryRun: true,
                emittedEvents: ['article.index_health_recorded'],
            ),
            new ActionDefinition(
